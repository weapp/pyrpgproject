            ...
            for z in range(len(capas)):
                for x in range(len(matriz[y])):
                    if not capas[z][y][x] == 0:
                        bloq = pygame.image.load("images/" + relacion [ capas[z][y][x] ]+".png")
                    ...
                    if posicion == [x,y,z]:
                        screen.blit(pygame.image.load("images/" + relacion['personaje'] + ".png").convert_alpha(),((SCREEN_WIDTH-TILE_WIDTH)/2, (SCREEN_HEIGHT-TILE_HEIGHT)/2))
        
        
        fondo=pygame.image.load("images/bar_izq.png")
